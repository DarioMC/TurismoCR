...
INSERT INTO Localizacion (ID_Localizacion, Direccion, Codigo_Postal,Ciudad,Provincia,ID_Pais)
        VALUES(1,'Rotonda Princial',1675,'Trinidad','BuenosAires',1);
...
INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(2,'Willian','Longe','WLonje89@gmail.com',64837561,'01-04-2017',2,8000,700,2,2); 

INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(3,'Andres','Rodriguez','Arod46@gmail.com',90473721,'23-02-2016',3,4000,200,3,3); 
                     
INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(4,'Xion','Park','XPark92@gmail.com',28836417,'02-01-2017',4,1000,3000,4,4);
                     
INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(5,'Henry','Hitler','hhiler91@gmail.com',42558582,'30-10-2005',2,4800,2000,5,5);
                     
INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(6,'Gengis','Kanh','genK78@gmail.com',65338578,'02-02-2014',2,11000,1000,2,2); 
                     
INSERT INTO Empleado (ID_Empleado,Nombre,Apellido,Email,Telefono,Fecha_Contratacion,
                     ID_Puesto,Salario,Por_Comision ,ID_Gerente, ID_Departamento)
                     VALUES(7,'John','Smith','jsmith29@gmail.com',76554383,'11-05-2013',3,3800,1200,3,3);                     
